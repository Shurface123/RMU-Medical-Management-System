                        ...
                        <tr id="row_<?php echo $p['allocation_id']; ?>">
                            ...
                            <td style="text-align:right;">
                                <div style="display:inline-flex;gap:.5rem;">
                                    <button class="adm-btn adm-btn-success adm-btn-sm" onclick="approveBudget(<?php echo $p['allocation_id']; ?>)">
                                        <i class="fas fa-check"></i> Approve
                                    </button>
                                    <button class="adm-btn adm-btn-danger adm-btn-sm" onclick="rejectBudget(<?php echo $p['allocation_id']; ?>)">
